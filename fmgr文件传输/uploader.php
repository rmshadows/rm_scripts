...
$external = array(
    ...
    'css-bootstrap' => '<link href="./res/cdn.jsdelivr.net.npm.bootstrap@5.2.2.dist.css.bootstrap.min.css" rel="stylesheet" integrity="sha384-Zenh87qX5JnK2Jl0vWa8Ck2rdkQ2Bzep5IDxbcnCeuOxjzrPF/et3URy9Bv1WTRi" crossorigin="anonymous">',
    // https://cdnjs.cloudflare.com/ajax/libs/dropzone/5.9.3/min/dropzone.min.css
    'css-dropzone' => '<link href="./res/cdnjs.cloudflare.com.ajax.libs.dropzone.5.9.3.min.dropzone.min.css" rel="stylesheet">',
    // 注意额外的字体文件
    // 'css-font-awesome' => '<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css" crossorigin="anonymous">',
    'css-font-awesome' => '<link rel="stylesheet" href="./res/cdnjs.cloudflare.com.ajax.libs.font-awesome.4.7.0.css.font-awesome.min.css" crossorigin="anonymous">',
    ...
    'css-highlightjs' => '<link rel="stylesheet" href="./res/cdnjs.cloudflare.com.ajax.libs.highlight.js.11.6.0.styles.' . $highlightjs_style . '.min.css">',
    // https://cdnjs.cloudflare.com/ajax/libs/ace/1.13.1/ace.js
    'js-ace' => '<script src="./res/cdnjs.cloudflare.com.ajax.libs.ace.1.13.1.ace.js"></script>',
    // https://cdn.jsdelivr.net/npm/bootstrap@5.2.2/dist/js/bootstrap.bundle.min.js
    'js-bootstrap' => '<script src="./res/cdn.jsdelivr.net.npm.bootstrap@5.2.2.dist.js.bootstrap.bundle.min.js" integrity="sha384-OERcA2EqjJCMA+/3y+gxIOqMEjwtxJY7qPCqsdltbNJuaOe923+mo//f6V8Qbsw3" crossorigin="anonymous"></script>',
    // https://cdnjs.cloudflare.com/ajax/libs/dropzone/5.9.3/min/dropzone.min.js
    'js-dropzone' => '<script src="./res/cdnjs.cloudflare.com.ajax.libs.dropzone.5.9.3.min.dropzone.min.js"></script>',
    // https://code.jquery.com/jquery-3.6.1.min.js
    'js-jquery' => '<script src="./res/code.jquery.com.jquery-3.6.1.min.js" integrity="sha256-o88AwQnZB+VDvE9tvIXrMQaPlFFSUTR+nldQm1LuPXQ=" crossorigin="anonymous"></script>',
    // https://cdn.datatables.net/1.13.1/js/jquery.dataTables.min.js
    'js-jquery-datatables' => '<script src="./res/cdn.datatables.net.1.13.1.js.jquery.dataTables.min.js" crossorigin="anonymous" defer></script>',
    // https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.6.0/highlight.min.js
    'js-highlightjs' => '<script src="./res/cdnjs.cloudflare.com.ajax.libs.highlight.js.11.6.0.highlight.min.js"></script>',
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <?php else: ?>
            <div class="col-12"><a href="./index.php" target="_blank" class="float-right text-muted">返回只读文件系统 <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
</form>
