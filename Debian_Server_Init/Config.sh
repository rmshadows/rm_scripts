...
# SSH开机是否自启 Preset=1
SET_ENABLE_SSH=1
# 部署一开始就写 SSH 空闲保活（云 NAT/防火墙常掐无流量连接）。reload 不踢当前会话。Preset=1
SET_SSH_KEEPALIVE=1
SET_SSH_CLIENT_ALIVE_INTERVAL=60
SET_SSH_CLIENT_ALIVE_COUNT_MAX=3
# 安装配置npm Preset=0
SET_INSTALL_NPM=0
...
# 设置网站根目录 Preset=0 0指的是默认~/nginx(或者apache2)/ 其他请指定
